                                                ...
                                                <div class="col-lg-6">
                                                    <div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input id="input-mask" name="nama_user" class="form-control input-mask">                                                            
                                                        </div>    

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">NISN</label>
                                                            <input type="text" id="input-mask" name="nisn" class="form-control input-mask">                                                            
                                                        </div>   
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="password" id="input-mask" name="password" class="form-control input-mask">                                                            
                                                        </div>
                                                        ...
                                                        <!-- <div class="mb-4" id="hidden_div" style="display: none;">
