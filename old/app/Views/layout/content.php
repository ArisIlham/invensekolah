                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Total Transaksi</h5>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Jumlah Karyawan</h5>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Jumlah Ruangan</h5>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-13 text-uppercase text-white-50">Total Pasien</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4">Grafik Data Pasien Terdaftar Perbulan Tahun 2023</h4>

                                        <div class="row justify-content-center">
                                            <div class="col-sm-3">
                                                <div class="text-center">
                                                    <h5 class="mb-0 font-size-20">86541</h5>
                                                <p class="text-muted">Bayi</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="text-center">
                                                    <h5 class="mb-0 font-size-20">2541</h5>
                                                    <p class="text-muted">Balita</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="text-center">
                                                    <h5 class="mb-0 font-size-20">102030</h5>
                                                <p class="text-muted">Anak-Anak</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="text-center">
                            ...
                            <div class="col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div>
                                            <h4 class="card-title mb-4">Penyakit Paling Populer</h4>
                                        </div>
                                        <div class="wid-peity mb-4">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div>
                                                        <p class="text-muted">Demam Biasa</p>
                                        ...
                                        <div class="wid-peity mb-4">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div>
                                                        <p class="text-muted">Demam Berdarah</p>
