                    ...
                    <div class="container-fluid">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Laporan User</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Data Laporan User</li>
                                    </ol>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body"> 
                                        <h4 class="card-title mb-4">Form Laporan User</h4>

                                        <form target="_blank" action="<?php echo base_url('laporan_user/cetakpdf');?>" method="POST" enctype="multipart/form-data"> 
