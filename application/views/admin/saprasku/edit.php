                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Form Edit Saprasku</h4>
                                        <form action="<?php echo base_url('saprasku/ubahsimpan');?>" method="POST" enctype="multipart/form-data"> 
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input id="input-mask" value="<?= $edit['kode_barang'];?>" name="kode_barang" class="form-control input-mask">                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Nama Barang</label>
                                                            <input id="input-mask" value="<?= $edit['nama_barang'];?>" name="nama_barang" class="form-control input-mask">                                                            
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Harga Beli</label>
                                                            <input id="input-mask" value="<?= $edit['harga_beli'];?>" name="harga_beli" class="form-control input-mask">                                                            
                                                        </div>                                                         
                                                        
                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Jumlah</label>
                                                            <input id="input-mask" value="<?= $edit['stok'];?>" name="stok" class="form-control input-mask">                                                            
                                                        </div>   

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Satuan</label>
                                                            <input id="input-mask" value="<?= $edit['satuan'];?>" name="satuan" class="form-control input-mask">                                                            
                                                        </div> 

                                                        <div class="mb-4">
                                                            <label class="form-label" for="input-mask">Kondisi</label>
                                                            <input id="input-mask" value="<?= $edit['kondisi'];?>"  name="kondisi" class="form-control input-mask">                                                            
                                                        </div>   
                                                        <div class="mb-4">
